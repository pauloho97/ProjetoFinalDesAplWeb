...
public class VendasControllerAPI {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "salvo com sucesso"),
			@ApiResponse(responseCode = "400", description = "erro de validação na venda") })
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "retorna uma lista de vendas") })
	@RequestMapping(value = "/v1/venda", method = RequestMethod.GET)
	public ResponseEntity<List<Venda>> listar() {

		System.out.println("executando listar ");
		return ResponseEntity.ok(vendasService.listar());
	}

	@Operation(summary = "retorna o total de vendas realizadas")
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "retorna o total de vendas realizadas") })
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "retorna o total em valores em reais das vendas realizadas") })
	@RequestMapping(value = "/v1/venda/total_valores_venda", method = RequestMethod.GET)
